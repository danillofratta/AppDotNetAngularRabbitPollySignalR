...
namespace ApiOrder.Service
{
    public class ConsumerWaitPaymentService : BackgroundService
    {
        ...
        public ConsumerWaitPaymentService(RabbitMqService rabbitMqService, IServiceScopeFactory scopeFactory, IHubContext<NotificationHub> hubContext)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            //{
                ...
                _rabbitMqService.ReceiveMessages(async (message) =>
                {
                    ...
                    this.OrderStatusWaitPayment(order, dbContext);
                });
