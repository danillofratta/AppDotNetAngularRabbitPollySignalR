...
namespace ApiOrder.Service
{
    public class ConsumerPaymentOkService : BackgroundService
    {
        ...
        public ConsumerPaymentOkService(RabbitMqService rabbitMqService, IServiceScopeFactory scopeFactory, IHubContext<NotificationHub> hubContext)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            //{
                ...
                _rabbitMqService.ReceiveMessages(async (message) =>
                {
                    ...
                    this.OrderStatusPaymentOk(order, dbContext);
                });
